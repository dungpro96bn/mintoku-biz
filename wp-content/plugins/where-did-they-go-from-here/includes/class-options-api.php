<?php
/**
 * WebberZone Followed Posts Options API.
 *
 * @since 3.2.0
 *
...
class Options_API {
	 ...
	 * @var string
	 */
	const SETTINGS_OPTION = 'wherego_settings';
	 ...
	 * Update an option.
	 *
	 * Updates a setting value in both the db and the static variable.
