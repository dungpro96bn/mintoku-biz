...
$i++;
$cfg['Servers'][$i]['host'] 			= 'mintoku-wp-stg.ct6ycmwwgldu.ap-northeast-1.rds.amazonaws.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '3UDmaO`I4v&}\"S0L2E}q;4,y~<z9%4P!' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/biz/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_TW1osPKhVt3Ci08rvRSaOMD/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://stg.mintoku.com/biz/wp-admin/?rand=79615369&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://stg.mintoku.com/biz/wp-admin/?rand=79770962&pma_logout=1';
