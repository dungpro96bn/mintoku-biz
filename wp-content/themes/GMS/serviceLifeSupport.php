                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-top">
                            <div class="info-content">
                                ...
                                <p class="text">24時間＋多言語対応、困った時に頼れる存在として、外国人材をしっかりサポート。日常生活から災害時・緊急時まで丁寧に対応し、安心できる暮らしをお約束します。</p>
                                <p class="note">※監理団体、登録支援機関でのの対応とは別のサービスです。</p>
                                <div class="see-more">
                                    <p>詳しく見る<span class="icon">＞</span></p>
                                </div>
                            </div>
