jQuery(function ($) {
  ...
  $(window).on('load', function(){     
        ...
        function control_imgResize() {
            ...
            if (parseInt($(window).width()) > 768) {
                $(window).scroll(function () {
                    ...
                    var heightTop = $("#header-menu").height();
                       if (fromTop > heightTop ) {
                        $("#header-menu .inner-header").addClass('pc-menu');
                        $("#header-menu .btn-openMenu-pc").addClass('open-pc');
                        $('#breadcrumb').hide()
                       }
                       else {
                        $("#header-menu .inner-header").removeClass('pc-menu ');
                        $("#header-menu .btn-openMenu-pc").removeClass('open-pc');
                        $("#header-menu .menu-pc").removeClass('is-open');
                        $("#header-menu .btn-openMenu-pc").removeClass('is-open');
						$(".list-service,.list-page,.investigation").removeClass('active');
                        $('#breadcrumb').show()
                       }            
                });                     
            }
        }
		$("#header-menu .btn-openMenu-pc").click(function () {
			$(this).next("#header-menu .menu-pc").toggleClass('is-open');		
			$(this).toggleClass("is-open");
			$(this).toggleClass("is-openMenu");
			$(this).find("span").toggleClass("open")
			$(this).next("#header-menu .menu-pc").find(".list-service,.list-page,.investigation").toggleClass('active')
		});
	...
	//css header fix	
	//css body margin-top height header
	var heightHeader = $("#header-menu").height();
	$("body").css("margin-top", heightHeader);
	
	window.onresize = function(event) {
		var heightTop = $("#wpadminbar").height();
