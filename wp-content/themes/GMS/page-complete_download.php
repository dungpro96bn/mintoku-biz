<?php
    /*
    * Template Name: completeDownload
                    ...
                    <ul class="selected-list">
                        <?php
                            ...
                            foreach($post as $post) {
                                ...
                                $post_file = get_field('file', $post_id);
                                $post_title = get_the_title($post_id);
                                ?>
                                <li class="selected-list-item">
                                    <a href="<?= $post_file['url']; ?>" title="<?= esc_html( $post_title ); ?>" target="_blank">
                ...
                <div class="inner">
                    ...
                    <div class="page-top">
                        <a href="#" class="page-top-anchor">
                            <picture>
                                <img src="<?php bloginfo('template_url');?>/images/common/page-top-anchor_white.png"
                                    alt="">
                            </picture>
                        </a>
                    </div>
