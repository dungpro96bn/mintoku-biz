            ...
            <div class="download-selected">
                <div class="selected-list">
                    ...
                    foreach ($posts as $single_post) {
                        ...
                        $acf_file = get_field('file', $post_id); // Thay 'acf_file_field_name' bằng tên custom field của bạn
                        $linkDownload = $acf_file['url'];
                        ...
                        <div style="display: none">
                            <input type="hidden" name="field_download_url_pdf" value="<?= esc_attr($linkDownload); ?>">
                        ...
                        <script>
                            $(document).ready(function (){
                                $urlPdf = $('input[name="field_download_url_pdf"]').val();
                                $titlePost = $('input[name="field_title_post"]').val();
                                $('input[name="title_post"]').val($titlePost);
                                $('input[name="download_url_pdf"]').val($urlPdf);
                            })
                        </script>
                        <?php
                    }
