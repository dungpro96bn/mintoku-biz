...
#bock-sevice .item-other .item-img,#bock-sevice .box-contact .list-img .item-img {
	...
	#bock-sevice .item-other .item-img,#bock-sevice .box-contact .list-img .item-img.full {
...
#bock-sevice .box-contact .left-contact {
	width: 60%;
}	
#bock-sevice .box-contact .right-contact {
	width: 40%;
}	
#bock-sevice .box-contact .list-img .item-img {
	width:50%
        ...
        <div class="inner">
            ...
            <ul class="list-other flex  <?php echo $classother; ?>" data-aos="fade-up">
                ...
                <li class="item-other three">
                    <a href="<?php echo   $link_other03; ?>">
                        <p class="title-other">専門家無料相談サービス</p>
                        <ul class="list-img flex list-home">
							 <li class="item-img full">
                                <picture class="box-img">
                                    <source srcset="<?php bloginfo('template_url');?>/images/top_case_people_full.png">
